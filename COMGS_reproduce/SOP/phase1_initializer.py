...
def _convert_irgs_refgs_model_args(model_args, fallback_optimizer_state, gaussians: GaussianModel):
    # RefGS materials are not directly compatible with COMGS visible-material
    # parameters, so we restore geometry/SH and reinitialize visible materials
    # into a stable range before downstream SOP processing.
...
def _build_parser() -> ArgumentParser:
    ...
    parser.add_argument(
        ...
        help="Checkpoint format for --checkpoint. Use irgs_refgs to load IRGS refgs checkpoints into SOP initialization.",
    )
