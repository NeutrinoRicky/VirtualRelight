...
def _print_efficiency_summary(split_name: str, summary: dict):
    print(
        ...
        f"(gbuffer={summary['gbuffer_render_sec']:.4f}s, sop+pbr={summary['sop_query_shading_sec']:.4f}s) "
    ...
    print(
        ...
        f"(gbuffer={summary['avg_gbuffer_ms_per_view']:.3f}ms, sop+pbr={summary['avg_sop_query_shading_ms_per_view']:.3f}ms) "
